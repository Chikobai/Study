...
class RestorePasswordAdapter: NSObject {

    private var items: [RestorePasswordSection] = []
    weak var delegate: RestorePasswordDelegate?
...
extension RestorePasswordAdapter: UITableViewDelegate, UITableViewDataSource {
...
private extension RestorePasswordAdapter {

    func filledButtonItemView(
        with tableView: UITableView,
        _ indexPath: IndexPath,
        _ type: RestorePasswordItem
        ) -> FilledButtonItem {
